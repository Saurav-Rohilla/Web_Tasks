...
<html>
    ...
    <body>
        ...
        <?php
            $sql = "select * from tbrecord order by id desc";
            ...
            if(mysqli_num_rows($result) > 0)
            {
                ...
                {
                    echo "Id: " . $row["id"] . "First name: " . $row["First_Name"] . "  Middle name: " . $row["Middle_Name"] . "   Last name: " . $row['Last_Name'] . " Phone_Number: " . $row['Phone_Number'] ;
                    echo "<input type='submit' class='deleteButton' value='Delete this Record' id='$row[id]'><br>";
